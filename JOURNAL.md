...
-  A couple of the challenges I faced in this part of the design before creating this journal markdown file were integrating a display that would fit the same footprint as the joystick. Also, I need to find a joystick that has breakout pins instead of some weird ribbon cable connector. Another one was definitely the ESP32 and figuring out how to secure it while still having access to the GPIO pins. I went through a couple of different revisions, some that included holes and others that included just rails to keep it in place. Also, finding a step-up board that would turn the 3.3V of the battery to the 5V for the servo that would fit within the handle was also a challenge. 
